                    ...
                    <div class="media">
                            <a class="thumbnail pull-left mr-4">
                                <?php if($Data['Image'] != "") { ?>
                                    ...
                                    <?php } else { ?>
                                    <img class="media-object"  src="<?= base_url()?>/asset/image/Mahasiswa/default.png" style="width: 230px; height: 230px; object-fit: cover;" width="230px" height="230px" alt="avatar image">
                                <?php } ?>
                            </a>
