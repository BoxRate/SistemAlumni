...
<body class="fixed-nav sticky-footer bg-light sidenav-toggled" id="page-top">
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="background-color: #9aceff;" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <li class="nav-item mt-4" data-toggle="tooltip" data-placement="right" title="Beranda">
          <a class="nav-link" href="<?= base_url()?>index.php/Alumni/dashboard">
            <i style="" class="fa fa-fw fa-home"></i>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pencarian">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a class="fa fa-search"  href="<?= base_url() ?>index.php/Alumni/nim"> Berdasarkan Nim</a>
            </li>
            <li>
              <a class="fa fa-search" href="<?= base_url() ?>index.php/Alumni/nama"> Berdasarkan Nama</a>
            </li>
            <li>
              <a class="fa fa-search" href="<?= base_url() ?>index.php/Alumni/tahun"> Berdasarkan Tahun Lulus</a>
            </li>
          </ul>
        </li>

        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Data Alumni">
          <a class="nav-link" href="<?= base_url() ?>index.php/Alumni/dataAlumni">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item avatar dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right dropdown-secondary animate slideIn" aria-labelledby="navbarDropdownMenuLink-5">
              <li>
              <a class="nav-link" href="<?php echo base_url() ?>index.php/Alumni/setting">
